...
require_once __DIR__ . '/../../public/models/InsuranceModel.php';
use EstatePlanningManager\Models\InsuranceModel;

class InsuranceTable extends \EstatePlanningManager\Tables\EPM_AbstractTable implements \EstatePlanningManager\Tables\TableInterface {
    ...
    public function create($charset_collate) {
        ...
        $modelFields = InsuranceModel::getFieldDefinitions();
