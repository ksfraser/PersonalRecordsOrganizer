...
require_once __DIR__ . '/../../public/models/OnlineAccountsModel.php';
use EstatePlanningManager\Models\OnlineAccountsModel;

class OnlineAccountsTable extends \EstatePlanningManager\Tables\EPM_AbstractTable implements \EstatePlanningManager\Tables\TableInterface {
    ...
    public function create($charset_collate) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'epm_online_accounts';
        $modelFields = OnlineAccountsModel::getFieldDefinitions();
