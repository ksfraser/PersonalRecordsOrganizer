...
class SafetyDepositBoxTable extends \EstatePlanningManager\Tables\EPM_AbstractTable implements \EstatePlanningManager\Tables\TableInterface {
    ...
    public function create($charset_collate) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'epm_safety_deposit_box';
        $modelFields = SafetyDepositBoxModel::getFieldDefinitions();
