...
class RealEstateTable extends \EstatePlanningManager\Tables\EPM_AbstractTable implements \EstatePlanningManager\Tables\TableInterface {
    ...
    public function create($charset_collate) {
        ...
        $modelFields = RealEstateModel::getFieldDefinitions();
