...
require_once __DIR__ . '/../../public/models/EmailAccountsModel.php';
use EstatePlanningManager\Models\EmailAccountsModel;

class EmailAccountsTable extends \EstatePlanningManager\Tables\EPM_AbstractTable implements \EstatePlanningManager\Tables\TableInterface {
    ...
    public function create($charset_collate) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'epm_email_accounts';
        $modelFields = EmailAccountsModel::getFieldDefinitions();
