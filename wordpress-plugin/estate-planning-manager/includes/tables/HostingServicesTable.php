...
class HostingServicesTable extends \EstatePlanningManager\Tables\EPM_AbstractTable implements \EstatePlanningManager\Tables\TableInterface {
    ...
    public function create($charset_collate) {
        global $wpdb;
        $table_name = $wpdb->prefix . 'epm_hosting_services';
        $modelFields = HostingServicesModel::getFieldDefinitions();
