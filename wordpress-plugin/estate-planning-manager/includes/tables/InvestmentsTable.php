...
require_once __DIR__ . '/../../public/models/InvestmentsModel.php';
use EstatePlanningManager\Models\InvestmentsModel;

class InvestmentsTable extends \EstatePlanningManager\Tables\EPM_AbstractTable implements \EstatePlanningManager\Tables\TableInterface {
    ...
    public function create($charset_collate) {
        ...
        $modelFields = InvestmentsModel::getFieldDefinitions();
