...
require_once __DIR__ . '/../includes/tables/PersonalPropertyCategoriesTable.php';

class PersonalPropertyCategoriesTableTest extends TestCase {
    protected $wpdb;
    protected $table;
    ...
    protected function setUp(): void {
        global $wpdb;
        $this->wpdb = $wpdb;
        $this->table = new PersonalPropertyCategoriesTable();
        $this->table_name = $this->wpdb->prefix . 'epm_personal_property_categories';
