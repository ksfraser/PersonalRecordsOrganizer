...
require_once __DIR__ . '/../includes/tables/DigitalAssetTypesTable.php';

class DigitalAssetTypesTableTest extends TestCase {
    protected $wpdb;
    protected $table;
    ...
    protected function setUp(): void {
        global $wpdb;
        $this->wpdb = $wpdb;
        $this->table = new DigitalAssetTypesTable();
        $this->table_name = $this->wpdb->prefix . 'epm_digital_asset_types';
