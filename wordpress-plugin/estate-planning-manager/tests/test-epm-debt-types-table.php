...
require_once __DIR__ . '/../includes/tables/DebtTypesTable.php';

class DebtTypesTableTest extends TestCase {
    protected $wpdb;
    protected $table;
    ...
    protected function setUp(): void {
        global $wpdb;
        $this->wpdb = $wpdb;
        $this->table = new DebtTypesTable();
        $this->table_name = $this->wpdb->prefix . 'epm_debt_types';
