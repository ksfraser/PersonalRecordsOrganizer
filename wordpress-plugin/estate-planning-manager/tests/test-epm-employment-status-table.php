...
require_once __DIR__ . '/../includes/tables/EmploymentStatusTable.php';

class EmploymentStatusTableTest extends TestCase {
    protected $wpdb;
    protected $table;
    ...
    protected function setUp(): void {
        global $wpdb;
        $this->wpdb = $wpdb;
        $this->table = new EmploymentStatusTable();
        $this->table_name = $this->wpdb->prefix . 'epm_employment_status';
