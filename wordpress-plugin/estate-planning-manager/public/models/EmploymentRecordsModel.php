...
class EmploymentRecordsModel extends AbstractSectionModel {
    public function getTableName() {
        global $wpdb;
        return $wpdb->prefix . 'epm_employment_records';
    }
    ...
    public function getSummaryFields() {
        return ['id', 'employer_name', 'start_year', 'end_year'];
    }
    ...
    public static function getFieldDefinitions() {
        return [
            ...
            'employer_name' => [ 'label' => 'Employer Name', 'type' => 'text', 'required' => true, 'db_type' => 'VARCHAR(255)' ],
